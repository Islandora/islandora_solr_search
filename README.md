...
Islandora Solr provides a pluggable backend for the creation of breadcrumbs. To enable it, browse to Administration » Islandora » Configuration and choose **Islandora Solr** under **Breadcrumb generation**.
